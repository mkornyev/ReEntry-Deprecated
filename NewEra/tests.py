...
from NewEra.models import User, CaseLoadUser, Referral, Resource, Tag
...
class UserTests(TestCase):
	...
	def test_case_load(self):
		...
		# Set up case load
		c1 = CaseLoadUser.objects.create(first_name="George", last_name="Test", email="test@test.net", phone="5555555555", notes="Test Notes Here", user=brenth)
		c2 = CaseLoadUser.objects.create(first_name="Martha", last_name="Test", email="testing@site.org", phone="6666666666", notes="Test Again and Again", user=brenth)
		c3 = CaseLoadUser.objects.create(first_name="Steve", last_name="Test", email="test@abcd.com", phone="7777777777", notes="One More", user=maxk)
